...
final class RemoteFeedLoaderTests: XCTestCase {
    ...
    /*
     By using factory method in the test scope we also prevent test methods from breaking in the future
     if we ever decide to change the production types again
     */
